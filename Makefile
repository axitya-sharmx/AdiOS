...
test: $(BUILD_DIR)/test_spinlock $(BUILD_DIR)/test_spinlock_guard $(BUILD_DIR)/test_span $(BUILD_DIR)/test_bitops
	$(BUILD_DIR)/test_spinlock
	$(BUILD_DIR)/test_spinlock_guard
	$(BUILD_DIR)/test_span
	$(BUILD_DIR)/test_bitops
...
$(BUILD_DIR)/test_bitops: tests/unit/test_bitops.c kernel/core/bitops.h
	@mkdir -p $(BUILD_DIR)
	$(CC) -Wall -Wextra tests/unit/test_bitops.c -o $@
